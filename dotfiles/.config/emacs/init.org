...
- [[#evil-mode-related-stuff][Evil mode related stuff]]
- [[#font-config][Font config]]
- [[#setting-up-which-key][Setting up which-key]]
- [[#setting-up-general-for-general-key-mapping][Setting up general for general key mapping.]]
- [[#setting-up-sensible-undos][Setting up sensible undos]]
- [[#nerd-icon-for-extra-spice][Nerd icon for extra spice.]]
- [[#misc][Misc]]
...
* Setting up general for general key mapping.
- F is for find.
- B is for buffer.
- And some Meta(Alt) rebind of evil.
  #+begin_src emacs-lisp
    (use-package general
      :config
      (general-evil-setup)
